package com.pgg.mywechatem.zxing.camera;
...
public final class CameraManager {
	...
	private static final int MIN_FRAME_WIDTH = Utils.dipToPixel(BaseApplication.getContext(), 250);
	private static final int MIN_FRAME_HEIGHT = Utils.dipToPixel(BaseApplication.getContext(), 250);
	private static final int MAX_FRAME_WIDTH = Utils.dipToPixel(BaseApplication.getContext(), 250);
	private static final int MAX_FRAME_HEIGHT = Utils.dipToPixel(BaseApplication.getContext(), 250);
